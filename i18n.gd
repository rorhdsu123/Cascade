...
const STR: Dictionary = {
	"en": {
		...
		"st15_name": "Three Colors",
		"st15_tag": "Three quotas at once — decide which color to finish first",
		"st16_name": "Two Clocks",
		"st16_tag": "Splitters race down, fuses burn — which deadline first?",
		"st17_name": "Paper Wings",
		"st17_tag": "Planes sit on the board — spend a line to pick one up",
		"st18_name": "Last Plane",
		"st18_tag": "Only one plane, and it's a long wait — spend it or save it",
		# Protect 3판(S27). st14_name/tag는 파킹 시절 문구라 은퇴 — 키는 안정 ID라 재사용하지 않는다.
		"st19_name": "Vault",
		"st19_tag": "Thieves grab and run — block them, or chase them down",
		"st20_name": "Two Fronts",
		"st20_tag": "Thieves inside the swarm — you can't hold both lines",
		"st21_name": "Double Loot",
		"st21_tag": "They take two at a time — chasing them down is no longer optional",
		# ── 설정 모달 ──
		"settings": "Settings",
		"sound": "Sound",
	...
	"ko": {
		...
		"st15_name": "세 색",
		"st15_tag": "채울 곳이 셋 — 어느 색부터 끝낼지 정해라",
		"st16_name": "두 개의 시계",
		"st16_tag": "분열은 내려오고 도화선은 탄다 — 어느 마감이 먼저인가",
		"st17_name": "종이 날개",
		"st17_tag": "비행기가 보드에 놓여 있다 — 줄 하나를 주고 집어라",
		"st18_name": "마지막 비행기",
		"st18_tag": "한 대뿐이고 다음은 한참 뒤 — 지금 쓸까 아껴둘까",
		"st19_name": "금고",
		"st19_tag": "도둑이 채가서 도망친다 — 막거나, 쫓아가 되찾아라",
		"st20_name": "두 전선",
		"st20_tag": "무리 속에 도둑 — 아래위를 다 지킬 수는 없다",
		"st21_name": "두 배로 턴다",
		"st21_tag": "한 번에 두 개씩 — 이제 쫓아가는 건 선택이 아니다",
		"settings": "설정",
		"sound": "소리",
		"haptic": "진동",
		"home": "홈",
