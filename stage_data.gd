...
#    2 무리                Hold            기존
#    3 속공                Hold            기존
#    4 비행기 주역          Plane R1        🆕 저작만
#    5 퍼즐 LEAN           Hold·pool       기존 ⚡
#    6 보석1               Collect R1      기존
#    7 폭탄 R1             Defuse R1       기존
#    8 장갑                Hold·tank       기존
#    9 비행기 희소          Plane R2        🆕 저작만
#   10 복습(전 4종)         Hold            기존 ⚡
#   11 도둑 R1             Protect R1      🆕 가독성 재설계 선행
#   12 분열                Hold·split      기존
#   13 보석2               Collect R2      기존
#   14 도둑 R2             Protect R2      🆕 가독성 재설계 선행
#   15 폭탄 R2             Defuse R2       기존 ⚡
#   16 보석3(3색)          Collect R3      🆕 저작만
#   17 폭탄 R3             Defuse R3       기존
#   18 분열 × 폭탄         교차             🆕 저작만
#   19 도둑 R3             Protect R3      🆕 가독성 재설계 선행
#   20 클라이맥스(+도둑)    프런티어         기존, 재저작 ⚡
#
...
# ⚠**칸 수가 스테이지 상한이다.** 지금 20칸 · STAGES 13개 = 위쪽 탑 일곱 칸은 영영 안 켜지고,
